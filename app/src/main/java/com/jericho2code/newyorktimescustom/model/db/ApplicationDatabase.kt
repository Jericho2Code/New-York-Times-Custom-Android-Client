...
import com.jericho2code.newyorktimescustom.model.db.converters.LocalDateTimeConverter
...
@TypeConverters(StringListConverter::class, MultimediaListConverter::class, LocalDateTimeConverter::class)
